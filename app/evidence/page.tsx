...
export default function EvidencePage() {
  ...
  const baselineOptions = useMemo(() => {
    ...
    for (const row of rows) {
      ...
      if (row.__meta.occurrenceId) values.set(`occurrence|${row.__meta.occurrenceId}`, `Source occurrence · ${release} / ${String(row.LongName || row.ShortName || row["#"] || "Unassigned")}`);
    }
