...
export default function ConfigurationDetailPage() {
  ...
  const configRows = useMemo(() => (record ? rows.filter((row) => row.__meta.configurationNodeId === record.id) : getConfigurationRows(rows, nodeId)) as ManagedRecord24[], [nodeId, record, rows]);
