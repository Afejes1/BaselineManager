...
export default function IntakePage() {
  ...
  return <DomainPageShell title="A2O Tech Stack Exchange" subtitle="Import history, automated baseline checks, and analyst review." releaseScope={active ? `Current exchange: ${active.fileName}` : "No imported exchange file"} contextMode="portfolio" actions={<Link className="primary-button" href="/">Open baseline records</Link>}>
