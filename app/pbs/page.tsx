...
export default function PbsPage() {
  ...
  return <DomainPageShell title="Product Structure" subtitle="Products organized by release and deployment location." releaseScope={releaseLens || "All releases"} contextMode="filter" actions={<label className="search"><span>⌕</span><input value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Find product, alias, or source key" /></label>}>
