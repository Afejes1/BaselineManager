...
export default function PbsPage() {
  ...
  const products = useMemo(() => {
    ...
    for (const row of selectedRows) {
      const id = row.__meta.productId || `record:${String(row["#"] || "unknown")}`;
