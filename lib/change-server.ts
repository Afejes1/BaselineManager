...
type RequestRow = {
  id: string; type_id: string; type_code: string; type_label: string; external_system: string | null; external_identifier: string; title: string; external_status: string | null; external_owner: string | null; source_locator: string | null; source_as_of: string | null; requested_release_id: string | null; requested_release_name: string | null; government_priority: GovernmentPriority; decision_status: FundingDecision; decision_authority: string | null; decision_at: string | null; decision_rationale: string | null; reference_status: ChangeRequestReferenceStatus; lifecycle_rationale: string | null; summary: string | null; source_description: string | null; government_synopsis: string | null; description_authority: "reported" | "analyst_transcribed" | "migrated_unclassified"; consequence_if_funded: string | null; consequence_if_deferred: string | null; impact_summary: string | null; knock_on_effects: string | null; updated_at: string;
};
type EffectRow = {
